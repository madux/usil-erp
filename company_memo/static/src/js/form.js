...
odoo.define('member_app.member_app', function (require) {
    "use strict";
    ...
    var OPTIONS = ['member_app.create',
                   'member_app.create_edit',
                   'member_app.limit',
                   'member_app.search_more',
                   'member_app.m2o_dialog',];
    ...
    FieldMany2One.include({
        ...
        show_error_displayer: function () {
            if(this.is_option_set(this.options.m2o_dialog) ||
               _.isUndefined(this.options.m2o_dialog) && this.is_option_set(this.view.ir_options['member_app.m2o_dialog']) ||
               this.can_create && _.isUndefined(this.options.m2o_dialog) && _.isUndefined(this.view.ir_options['member_app.m2o_dialog'])) {
        ...
        get_search_result: function (search_val) {
            ...
            if (_.isUndefined(this.view))
                ...
                if (!_.isUndefined(this.view.ir_options['member_app.limit'])) {
                this.limit = parseInt(this.view.ir_options['member_app.limit'], 10);
            }
            ...
            $.when(search_result).then(function (data) {
                ...
                var can_search_more = (self.options && self.is_option_set(self.options.search_more)),
                    search_more_undef = _.isUndefined(self.options.search_more) && _.isUndefined(self.view.ir_options['member_app.search_more']),
                    search_more = self.is_option_set(self.view.ir_options['member_app.search_more']);
                ...
                var quick_create = self.is_option_set(self.options.create) || self.is_option_set(self.options.quick_create),
                    ...
                    m2x_create_undef = _.isUndefined(self.view.ir_options['member_app.create']),
                    m2x_create = self.is_option_set(self.view.ir_options['member_app.create']);
                ...
                var create_edit = self.is_option_set(self.options.create) || self.is_option_set(self.options.create_edit),
                    ...
                    m2x_create_edit_undef = _.isUndefined(self.view.ir_options['member_app.create_edit']),
                    m2x_create_edit = self.is_option_set(self.view.ir_options['member_app.create_edit']),
